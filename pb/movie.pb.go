...
type MPARating int32

const (
	MPARating_G    MPARating = 0
	MPARating_PG   MPARating = 1
	MPARating_PG13 MPARating = 2
	MPARating_R    MPARating = 3
	MPARating_NC17 MPARating = 4
)

// Enum value maps for MPARating.
var (
	MPARating_name = map[int32]string{
		0: "G",
		1: "PG",
		2: "PG13",
		3: "R",
	...
	MPARating_value = map[string]int32{
		"G":    0,
		"PG":   1,
		"PG13": 2,
		"R":    3,
...
func (x MPARating) Enum() *MPARating {
	p := new(MPARating)
	*p = x
	return p
}

func (x MPARating) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MPARating) Descriptor() protoreflect.EnumDescriptor {
	return file_movie_proto_enumTypes[0].Descriptor()
}

func (MPARating) Type() protoreflect.EnumType {
	return &file_movie_proto_enumTypes[0]
}

func (x MPARating) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MPARating.Descriptor instead.
func (MPARating) EnumDescriptor() ([]byte, []int) {
...
type Movie struct {
	...
	MpaRating   MPARating `protobuf:"varint,6,opt,name=mpa_rating,json=mpaRating,proto3,enum=pb.MPARating" json:"mpa_rating,omitempty"`
}
...
func (x *Movie) GetMpaRating() MPARating {
	if x != nil {
		return x.MpaRating
	}
	return MPARating_G
...
type PutMovieRequest struct {
	...
	Movie *Movie `protobuf:"bytes,1,opt,name=grpcapi,proto3" json:"grpcapi,omitempty"`
}
...
type GetMovieResponse struct {
	...
	StatusCode int32  `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`
	Message    string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Movie      *Movie `protobuf:"bytes,3,opt,name=grpcapi,proto3" json:"grpcapi,omitempty"`
}
...
var file_movie_proto_rawDesc = []byte{
	...
	0x62, 0x22, 0xb8, 0x01, 0x0a, 0x05, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x74,
	...
	,
	...
	0x28, 0x09, 0x52, 0x06, 0x74, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0x6e, 0x0a, 0x10, 0x47, 0x65,
	...
	0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1f, 0x0a, 0x05, 0x6d, 0x6f, 0x76,
	0x69, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x70, 0x62, 0x2e, 0x4d, 0x6f,
	0x76, 0x69, 0x65, 0x52, 0x05, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x22, 0x31, 0x0a, 0x10, 0x47, 0x65,
	0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d,
	0x0a, 0x0a, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x71, 0x75, 0x65, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x71, 0x0a,
	...
	0x06, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e,
	0x70, 0x62, 0x2e, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52, 0x06, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x73,
	0x22, 0x2c, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x63, 0x6f, 0x6e, 0x73, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0x50,
	...
	,
	...
	0x73, 0x65, 0x12, 0x38, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x12,
	0x14, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x6f,
	0x76, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x0b,
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x12, 0x16, 0x2e, 0x70, 0x62,
	0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x6f, 0x76, 0x69, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d,
...
var file_movie_proto_goTypes = []interface{}{
	(MPARating)(0),              // 0: pb.MPARating
	(*Movie)(nil),               // 1: pb.Movie
	(*PutMovieRequest)(nil),     // 2: pb.PutMovieRequest
	(*PutMovieResponse)(nil),    // 3: pb.PutMovieResponse
	(*GetMovieRequest)(nil),     // 4: pb.GetMovieRequest
	(*GetMovieResponse)(nil),    // 5: pb.GetMovieResponse
	(*GetMoviesRequest)(nil),    // 6: pb.GetMoviesRequest
	(*GetMoviesResponse)(nil),   // 7: pb.GetMoviesResponse
	(*DeleteMovieRequest)(nil),  // 8: pb.DeleteMovieRequest
	(*DeleteMovieResponse)(nil), // 9: pb.DeleteMovieResponse
}
var file_movie_proto_depIdxs = []int32{
	0, // 0: pb.Movie.mpa_rating:type_name -> pb.MPARating
	1, // 1: pb.PutMovieRequest.grpcapi:type_name -> pb.Movie
	1, // 2: pb.GetMovieResponse.grpcapi:type_name -> pb.Movie
	1, // 3: pb.GetMoviesResponse.movies:type_name -> pb.Movie
	2, // 4: pb.MovieSvc.PutMovie:input_type -> pb.PutMovieRequest
	4, // 5: pb.MovieSvc.GetMovie:input_type -> pb.GetMovieRequest
	6, // 6: pb.MovieSvc.GetMovies:input_type -> pb.GetMoviesRequest
	8, // 7: pb.MovieSvc.DeleteMovie:input_type -> pb.DeleteMovieRequest
	3, // 8: pb.MovieSvc.PutMovie:output_type -> pb.PutMovieResponse
	5, // 9: pb.MovieSvc.GetMovie:output_type -> pb.GetMovieResponse
	7, // 10: pb.MovieSvc.GetMovies:output_type -> pb.GetMoviesResponse
	9, // 11: pb.MovieSvc.DeleteMovie:output_type -> pb.DeleteMovieResponse
